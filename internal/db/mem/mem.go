/*
mem - пакет, реализующий простейшую базу данных в памяти.
Был сделан в качестве очереди для одного из первых заданий на курсе.
В последствии очередь сделал универсальной, использующей ту базу данных,
которую передадут при создании (mem или mng).
*/
package mem
